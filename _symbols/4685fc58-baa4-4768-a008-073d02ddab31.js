...
function create_else_block(ctx) {
	...
	let mounted;
	let dispose;
	let each_value_2 = /*transactions*/ ctx[8];
	let each_blocks = [];
	...
	return {
		...
		h() {
			...
			if (/*type*/ ctx[9] === void 0) add_render_callback(() => /*select_change_handler_1*/ ctx[29].call(select));
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(select, "change", /*select_change_handler_1*/ ctx[29]),
					listen(input, "input", /*input_input_handler_1*/ ctx[30]),
					listen(button0, "click", /*addTransaction*/ ctx[20]),
					listen(button1, "click", /*logout*/ ctx[17])
				];
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*removeTransaction, transactions*/ 2097408) {
				each_value_2 = /*transactions*/ ctx[8];
				let i;
...
function create_if_block_2(ctx) {
	...
	let mounted;
	let dispose;
	let each_value_1 = /*allUsers*/ ctx[12];
	let each_blocks_1 = [];
	...
	let if_block = /*errorMessage*/ ctx[3] && create_if_block_3(ctx);
	...
	return {
		c() {
			...
			div1 = element("div");
			h21 = element("h2");
			t5 = text("Change Password");
			t6 = space();
			select = element("select");
			option = element("option");
			t7 = text("Select a user");
		...
		l(nodes) {
			...
			t5 = claim_text(h21_nodes, "Change Password");
			...
			t7 = claim_text(option_nodes, "Select a user");
			...
			input = claim_element(div1_nodes, "INPUT", { type: true, placeholder: true });
			...
			var button1_nodes = children(button1);
			t13 = claim_text(button1_nodes, "Logout");
			button1_nodes.forEach(detach);
			div2_nodes.forEach(detach);
			this.h();
		},
		h() {
			attr(h1, "class", "svelte-1ao205d");
			attr(div0, "class", "admin-section");
			option.__value = "";
			option.value = option.__value;
			if (/*selectedUser*/ ctx[13] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[27].call(select));
			attr(input, "type", "password");
			attr(input, "placeholder", "New Password");
			attr(div1, "class", "admin-section");
			attr(button1, "class", "logout-button svelte-1ao205d");
			attr(div2, "class", "dashboard svelte-1ao205d");
		},
		m(target, anchor) {
			...
			select_option(select, /*selectedUser*/ ctx[13], true);
			append_hydration(div1, t8);
			append_hydration(div1, input);
			set_input_value(input, /*newPassword*/ ctx[14]);
			...
			if (!mounted) {
				dispose = [
					...
					listen(button0, "click", /*changePassword*/ ctx[19]),
					listen(button1, "click", /*logout*/ ctx[17])
				];
		...
		p(ctx, dirty) {
			if (dirty[0] & /*deleteUser, allUsers*/ 266240) {
				each_value_1 = /*allUsers*/ ctx[12];
				let i;
			...
			if (dirty[0] & /*selectedUser, allUsers*/ 12288) {
				select_option(select, /*selectedUser*/ ctx[13]);
			}

			if (dirty[0] & /*newPassword*/ 16384 && input.value !== /*newPassword*/ ctx[14]) {
				set_input_value(input, /*newPassword*/ ctx[14]);
			}
			...
			if (!mounted) {
				dispose = [
					...
					listen(button0, "click", function () {
						...
						? /*createAccount*/ ctx[16]
						: /*login*/ ctx[15])) (/*isCreatingAccount*/ ctx[4]
						? /*createAccount*/ ctx[16]
						: /*login*/ ctx[15]).apply(this, arguments);
					}),
					listen(button1, "click", /*click_handler*/ ctx[25])
				];
...
// (552:10) {#each transactions as transaction}
function create_each_block_2(ctx) {
	let li;
	let span;

	let t0_value = (/*transaction*/ ctx[40].type === 'income'
	? 'Income'
	: 'Expense') + "";

	let t0;
	let t1;
	let t2_value = /*transaction*/ ctx[40].amount.toFixed(2) + "";
	let t2;
	let t3;
	let button;
	let t4;
	...
	function click_handler_2() {
		return /*click_handler_2*/ ctx[31](/*transaction*/ ctx[40]);
	}
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*transactions*/ 256 && t0_value !== (t0_value = (/*transaction*/ ctx[40].type === 'income'
			? 'Income'
			: 'Expense') + "")) set_data(t0, t0_value);

			if (dirty[0] & /*transactions*/ 256 && t2_value !== (t2_value = /*transaction*/ ctx[40].amount.toFixed(2) + "")) set_data(t2, t2_value);
		},
		d(detaching) {
...
// (507:10) {#each allUsers as user}
function create_each_block_1(ctx) {
	let li;
	let span;
	let t0_value = /*user*/ ctx[35].username + "";
	let t0;
	let t1;
	let button;
	let t2;
	...
	function click_handler_1() {
		return /*click_handler_1*/ ctx[26](/*user*/ ctx[35]);
	}
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty[0] & /*allUsers*/ 4096 && t0_value !== (t0_value = /*user*/ ctx[35].username + "")) set_data(t0, t0_value);
		},
		d(detaching) {
			if (detaching) detach(li);
			mounted = false;
...
// (519:10) {#each allUsers as user}
function create_each_block(ctx) {
	let option;
	let t_value = /*user*/ ctx[35].username + "";
	let t;
	...
	return {
		...
		h() {
			option.__value = option_value_value = /*user*/ ctx[35].username;
			option.value = option.__value;
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*allUsers*/ 4096 && t_value !== (t_value = /*user*/ ctx[35].username + "")) set_data(t, t_value);

			if (dirty[0] & /*allUsers*/ 4096 && option_value_value !== (option_value_value = /*user*/ ctx[35].username)) {
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		...
		if (/*isAdmin*/ ctx[11]) return create_if_block_2;
...
function instance($$self, $$props, $$invalidate) {
	...
	// State for budget tracker (only for non-admin users)
	let totalIncome = 0;
	...
	// Load user data from localStorage (only for non-admin users)
	...
	// Save user data to localStorage (only for non-admin users)
	...
	function changePassword() {
		if (!selectedUser || !newPassword) {
			$$invalidate(3, errorMessage = 'Please select a user and enter a new password.');
			return;
		}
		...
		if (user) {
			...
			$$invalidate(3, errorMessage = '');
			$$invalidate(14, newPassword = '');
			alert(`Password for ${selectedUser} has been updated.`);
		} else {
			$$invalidate(3, errorMessage = 'User not found.');
		}
	}

	// Budget tracker functions (only for non-admin users)
	...
	const click_handler_1 = user => deleteUser(user.username);

	function select_change_handler() {
		selectedUser = select_value(this);
		$$invalidate(13, selectedUser);
		$$invalidate(12, allUsers);
	}
	...
	const click_handler_2 = transaction => removeTransaction(transaction.id);
